...
public class Company extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//dao 호출
		ArrayList<Dto> result = Dao.getInstance().Data();
		//json
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Dto dto = new Dto(0, cimg, cname, clevel, cform, cclassfy, csdate, csdate, csdate);
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setCharacterEncoding("UTF-8");	
			...
			System.out.println("Company.java doPut clevel ::: " + clevel);
			
			String cform = request.getParameter("cform");
			System.out.println("Company.java doPut cform ::: " + cform);
			
			String cclassfy = request.getParameter("cclassfy");
			System.out.println("Company.java doPut cclassfy ::: " + cclassfy);
			
			int cno = Integer.parseInt(request.getParameter("cno"));
			System.out.println("Company.java doPut cno ::: " + cno);
	  ...
	  //인사삭제
	   protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   response.getWriter().print(result);
			/*
			 * String cname = request.getParameter("cname"); System.out.println(cname); //
			 * 2. Dao에게 요청후 결과 받기 boolean result = Dao.getInstance().delete(cname);
			 * System.out.println( "result : " + request ); // 3. 결과 ajax에게 보내기
			 * response.getWriter().print(result);
			 */
	  }
}
