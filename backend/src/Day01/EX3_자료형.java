...
public class EX3_자료형 {
		...
		public static void main(String[] args) { //main s
			...
			byte b2= 127;	
			System.out.println("16진수:"+ b2);
			/* byte b3= 128; 범위 벚어나서 오류된 데이터 */
			
			// 3. short 자료형
			short s1= 32000; 
			System.out.println("short자료형:"+s1);
			...
			System.out.println("long자료형:"+ l2);//오류발생 100억
			...
			System.out.println("float자료형:"+f1); //데이터 뒤에f	붙여주기 소수 17자리까지
			...
			boolean bol1 = true;  
			System.out.println("blooean자료형:"+bol1); 
