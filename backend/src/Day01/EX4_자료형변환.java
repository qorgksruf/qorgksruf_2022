...
public class EX4_자료형변환 {//class s
			...
			//1.[p54] 자동타입변환 
				byte b1 = 10;	   int i1 =b1; //byte->int가능
				char c1 ='가'; 	   i1 =c1;	//char->int가능
				int i2 = 50; 	   long l1 = i2;	
				long l2 = 100;     float f1 = 12;
				float f2= 100.5f;  double d1=f2;
			
			//58p
			int i3 =2000000000; 	byte b2 = (byte)i3;	//int->byte전환 불가능 [강제는 가능]
			long l3 = 300; 			int i4 = (int)l3;
			int i5 = 65;	 		char c2 = (char)i5;	
			double d2 = 3.14;		int i6 = (int)d2;	//double-->int불가능
...
-피연산자중 큰 타입의 결과로 변환됨
	1. 정수
		1.int 보다 작은 byte, short 연산시 무조건 int결과
		 byte + byte->int
		 short + int->int
		2.long연산시
		 int+long->long
